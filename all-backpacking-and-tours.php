                ...
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="banner-content">
                            <h1>View all Backpacking & Tours</h1>
                            <ul class="breadcrumb-list">
                                <li><a href="index.php">Home</a></li>
                                <li>View all Backpacking & Tours</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    ?>
                      <div class="col-lg-4 col-md-6">
                        <div class="package-card3 style-3">
                            <a href="backpacking-details.php?id=<?php echo $row['id'] ?>" class="package-card-img">
                                <img src="<?php echo validate_image($row['image1']) ?>" alt />
                            </a>
                            <div class="package-card-content">
                                <div class="card-content-top">
                                    <h5><a href="backpacking-details.php?id=<?php echo $row['id'] ?>"><?php echo ucwords($row['treksname']) ?></a></h5>
                                ...
                                <div class="card-content-bottom">
                                    ...
                                    <div class="book-btn">
                                        <a href="backpacking-details.php?id=<?php echo $row['id'] ?>" class="primary-btn2">Book Now <i class="bi bi-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>

	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<div class="card-tools">
				...
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_project" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New Watersports</a>
			</div>
		</div>
			...
			<table class="table tabe-hover table-bordered table-compact" id="list">
				...
				<thead>
					<tr>
						...
						<th>Watersports Image</th>
						<th>Watersports Name</th>
...
<script>
	...
	$(document).ready(function(){
		$('.new_project').click(function(){
			location.href = _base_url_+"admin/?page=watersports/manage";
		})
		
		$('.ongoing_project').click(function(){
			location.href = _base_url_+"admin/?page=watersports&datafilter=ongoing";
		})
		
		$('.view_message').click(function(){
			location.href = _base_url_+"admin/?page=watersports/&id="+$(this).attr('data-id')
		})
		
		$('.manage_allproject').click(function(){
			location.href = _base_url_+"admin/?page=watersports/manage&id="+$(this).attr('data-id')
		})
		$('.delete_allproject').click(function(){
		_conf("Are you sure to delete this Watersports?","delete_allproject",[$(this).attr('data-id')])
		})

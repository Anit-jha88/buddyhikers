	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<div class="card-tools">
				...
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_project" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New Stay</a>
			</div>
		</div>
			...
			<table class="table tabe-hover table-bordered table-compact" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo ucwords($row['distance']) ?></b></td>
...
<script>
	...
	$(document).ready(function(){
		$('.new_project').click(function(){
			location.href = _base_url_+"admin/?page=stay/manage";
		})
		
		$('.ongoing_project').click(function(){
			location.href = _base_url_+"admin/?page=stay&datafilter=ongoing";
		})
		
		$('.view_message').click(function(){
			location.href = _base_url_+"admin/?page=stay/&id="+$(this).attr('data-id')
		})
		
		$('.manage_allproject').click(function(){
			location.href = _base_url_+"admin/?page=stay/manage&id="+$(this).attr('data-id')
		})
		$('.delete_allproject').click(function(){
		_conf("Are you sure to delete this stay?","delete_allproject",[$(this).attr('data-id')])
		})
		
			$('.delete_message').click(function(){
		_conf("Are you sure to delete this Stay?","delete_message",[$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
	function delete_message($id){
		start_loader()
		$.ajax({
			url:_base_url_+'admin/classes/Content.php?f=service_delete1',
			method:'POST',
			data:{id:$id},
			dataType:'json',

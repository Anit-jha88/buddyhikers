                    ...
                    <div class="row g-lg-4 gy-5 justify-content-center">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <h3>
                                <span>Have an Enquiry <br /></span> Get In Touch Now<span></span>
                                </h3>
                                <a href="#." class="primary-btn1">Contact Now</a>


                                <div class="payment-partner footer-bottom">
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                            <div class="footer-widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="https://buddyhikers.com/index.php">Home</a></li>
                                    <li><a href="#.">About Us</a></li>
                              
                                    <li><a href="https://buddyhikers.com/blog">Blog</a></li>
                                    <li><a href="https://buddyhikers.com/our-gallery.php">Our Gallery</a></li>
                                    <li><a href="https://buddyhikers.com/contact-us.php">Contact Us</a></li>
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                            <div class="footer-widget">
                                ...
                                <ul class="widget-list">
                                    ...
                                    <li><a href="https://buddyhikers.com/all-treks.php">Treks</a></li>
                                    <li><a href="#.">Caravan Tours</a></li>
                                    <li><a href="#.">Rentals</a></li>
                                    <li><a href="https://buddyhikers.com/all-watersports.php">Water sports</a></li>
                                    <li><a href="#.">Book Your Stay</a></li>
                                    <li><a href="https://buddyhikers.com/all-backpacking-and-tours.php">Backpacking & Tours</a></li>
                                    <li><a href="#.">Sustainable Tourism</a></li>
                                    <li><a href="#.">School/College/Corporate Program</a></li>
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                            <div class="footer-widget">
                                ...
                                <ul class="widget-list">
                                    ...
                                    <li><a href="https://buddyhikers.com/privacy-policy.php">Privacy Policy</a></li>
                                    <li><a href="https://buddyhikers.com/payment-policy.php">Payment Policy</a></li>
                                    <li><a href="https://buddyhikers.com/cancellation-and-refund-policy.php">Cancellation & Refund Policy</a></li>
                                    <li><a href="https://buddyhikers.com/terms-and-conditions.php">Terms and Conditions </a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                            <div class="footer-widget">
                                <div class="single-contact mb-20">
                                    <div class="widget-title">
                                    ...
                                    <a href="#.">
                                        Village Tugashi, Joshimath,  
                                        Uttarakhand 246483 India
                                    </a>
                                </div>
                                <div class="single-contact mb-20">
                                    <div class="widget-title">
                                    ...
                                    <a href="tel:+91 6396456878">+91 6396456878</a><br />
                                    <a href="tel:+91 9760767895">+91 9760767895</a>
                                </div>
                                <div class="single-contact mb-25">
                                    <div class="widget-title">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                                    ...
                                    <a href="mailto:buddyhikers@gmail.com">
                                        <span class="__cf_email__" >buddyhikers@gmail.com</span>
                                    </a>
                                </div>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-lg-12 ">
                            ...
                            <p>© 2024 BuddyHikers.com  All Rights Reserved. | Developed  By <a href="https://www.egenslab.com/">MKS Technosoft</a></p>
...
<script src="https://buddyhikers.com/assets/js/jquery-3.7.1.min.js"></script>
        <script src="https://buddyhikers.com/assets/js/jquery-ui.js"></script>
        <script src="https://buddyhikers.com/assets/js/moment.min.js"></script>
        <script src="https://buddyhikers.com/assets/js/daterangepicker.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/bootstrap.min.js"></script>
        <script src="https://buddyhikers.com/assets/js/popper.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/swiper-bundle.min.js"></script>
        <script src="https://buddyhikers.com/assets/js/slick.js"></script>

        <script src="https://buddyhikers.com/assets/js/waypoints.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/jquery.counterup.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/isotope.pkgd.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/jquery.magnific-popup.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/jquery.marquee.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/jquery.nice-select.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/select2.min.js"></script>
        <script src="https://buddyhikers.com/assets/js/jquery.fancybox.min.js"></script>

        <script src="https://buddyhikers.com/assets/js/custom.js"></script>  

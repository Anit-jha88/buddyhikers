...
<html lang="en">
    <head>
        ...
        <!-- End Header Section -->
        <title>Caravan Tours | Buddy Hikers</title>
    </head>
    <body>
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="banner-content">
                            <h1>View all Caravan Tours</h1>
                            <ul class="breadcrumb-list">
                                <li><a href="index.php">Home</a></li>
                                <li>View all Caravan Tours</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="package-card3 style-3">
                            ...
                            <div class="package-card-content">
                                ...
                                <div class="card-content-bottom">
                                    ...
                                    <div class="book-btn">
                                        <a href="caravan-details.php?id=<?php echo $row['id'] ?>" class="primary-btn2">Book Now <i class="bi bi-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>

                    ...
                    <div class="row g-lg-4 gy-5 justify-content-center">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <a href="contact-us.php" class="primary-btn1">Contact Now</a>
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-sm-start">
                            <div class="footer-widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="all-treks.php">Treks</a></li>
                                    <li><a href="all-caravan.php">Caravan Tours</a></li>
                                    <li><a href="#.">Rentals</a></li>
                                    <li><a href="all-watersports.php">Water sports</a></li>
                                    <li><a href="book-stay.php">Book Your Stay</a></li>
                                    <li><a href="all-backpacking-and-tours.php">Backpacking & Tours</a></li>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-lg-12 ">
                            ...
                            <p>© 2024 BuddyHikers.com  All Rights Reserved. | Developed  By <a href="https://www.mkstechnosoft.com/" target="_blank">MKS Technosoft</a></p>
